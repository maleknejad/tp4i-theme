            <section id="intro-header">
                ...
                <div class="container"><a class="intro-logo" href="#" title="شفافیت برای ایران"><img src="<?php echo get_stylesheet_directory_uri(). '/assets/images/logo.svg' ?>" alt="شفافیت برای ایران"></a>
                    ...
                    <ul class="intro-menu">
                        ...
                        <li class="intro-item"><a href="<?php echo get_site_url(); ?>/project" title="پروژه‌ها"><i class="icon icon-projects"></i><span>پروژه‌ها</span></a></li>
                        <li class="intro-item"><a href="<?php echo get_site_url(); ?>/academy" title="آکادمی"><i class="icon icon-academy"></i><span>آکادمی</span></a></li>
                        <li class="intro-item"><a href="<?php echo get_site_url(); ?>/map" title="نقشه"><i class="icon icon-pin"></i><span>نقشه</span></a></li>
                        <li class="intro-item"><a href="#" title="انجمن"><i class="icon icon-forum"></i><span>انجمن</span></a></li>
                    </ul>
                </div>
            </section>
            <div class="container">
